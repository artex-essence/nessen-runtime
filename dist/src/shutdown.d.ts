 ...
 * @param telemetry - Telemetry system to shutdown
 */
export declare function setupSignalHandlers(server: Server, state: StateManager, telemetry: Telemetry, onComplete?: (result: ShutdownResult, exitCode: number) => void, options?: {
