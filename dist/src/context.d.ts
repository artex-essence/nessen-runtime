 ...
 */
export declare function createContext(envelope: RequestEnvelope, classification: RequestClassification, params?: Record<string, string>, abortSignal?: AbortSignal): RequestContext;
