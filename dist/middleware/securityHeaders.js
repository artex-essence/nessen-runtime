...
function createSecurityHeadersMiddleware(config = {}) {
    const { contentTypeOptions = true, frameOptions = 'DENY', xssProtection = true, hstsMaxAge = 31536000, hstsIncludeSubDomains = true, referrerPolicy = 'strict-origin-when-cross-origin', permissionsPolicy = 'geolocation=(), microphone=(), camera=()', contentSecurityPolicy = "default-src 'self'; script-src 'self'; object-src 'none'", } = config;
